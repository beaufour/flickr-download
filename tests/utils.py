...
class TestPathSanitization(unittest.TestCase):
    def test_simple(self):
        self.assertEqual(
            get_full_path("moo", "foo.jpg"), "".join(["moo", os.path.sep, "foo.jpg"])
        )

    def test_separators(self):
        self.assertEqual(
            get_full_path("moo/boo", "foo.jpg"),
            "".join(["moo_boo", os.path.sep, "foo.jpg"]),
        )
        self.assertEqual(
            get_full_path("moo", "foo/faa.jpg"),
            "".join(["moo", os.path.sep, "foo_faa.jpg"]),
        )
        self.assertEqual(
            get_full_path("moo/boo", "foo/faa.jpg"),
    ...
    def test_get_dirname(self):
        ...
        self.assertEqual(
            get_dirname("".join(["and", os.path.sep, "or-mypath"])), "and_or-mypath"
        )
        self.assertEqual(get_dirname("".join(["and*", os.path.sep, "o:r?"])), "and_or")
